...
```{r ctn-train, echo = T, results = 'hide'}
# Standard Stacking 
...
```{r ctn-predict, echo = T, results = 'hide'}
# no stacking
...
```{r bin-data, echo = T, results = 'hide'}
...
```{r bin-train, echo = T, results = 'hide'}
...
```{r mix-data, echo = T, results = 'hide'}
...
```{r mix-training, echo = T, results = 'hide',warning=FALSE,message=FALSE}
...
```{r mix-mtd, echo = T, warning=FALSE,message=FALSE}
